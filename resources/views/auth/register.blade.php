                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="input-style-1">
                                ...
                                <input type="text" @error('username') class="form-control is-invalid" @enderror name="username" id="name" placeholder="{{ __('Username') }}" value="{{ old('username') }}" required autocomplete="username" autofocus>
                                @error('username')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
